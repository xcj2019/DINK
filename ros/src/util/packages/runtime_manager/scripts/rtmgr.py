...
button_Background = wx.Colour( 120,210,255 )
button_Foreground = wx.Colour( 0,128,255 )
Background = wx.Colour( 0,128,255 )
small_collour = wx.Colour( 197, 226, 255 )
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.tab_qs = wx.Panel(self, wx.ID_ANY)
		self.tab_qs.Hide()
		...
		self.tab_setup = wx.Panel(self, wx.ID_ANY)
		...
		self.button_can_setup = wx.ToggleButton(self.tab_setup, wx.ID_ANY, _("CAN"))
		self.button_tfserver_setup = wx.ToggleButton(self.tab_setup, wx.ID_ANY, _("TF SERVER"))
		...
		self.tab_map = wx.Panel(self, wx.ID_ANY)
		...
		self.button_rosbag_map.Hide()
		self.button_rviz_map.Hide()
		self.button_rqt_map.Hide()

		self.tab_sensing = wx.Panel(self, wx.ID_ANY)
		...
		self.button_rosbag_sensing.Hide()
		self.button_rviz_sensing.Hide()
		self.button_rqt_sensing.Hide()

		self.tab_computing = wx.Panel(self, wx.ID_ANY)
		...
		self.button_rosbag_computing.Hide()
		self.button_rviz_computing.Hide()
		self.button_rqt_computing.Hide()

		self.tab_interface = wx.Panel(self, wx.ID_ANY)
		self.tab_interface.Hide()
		...
		self.tab_database = wx.Panel(self, wx.ID_ANY)
		self.tab_database.Hide()
		...
		self.tab_simulation = wx.Panel(self, wx.ID_ANY)
		...
		self.button_rosbag_simulation.Hide()
		self.button_rviz_simulation.Hide()
		self.button_rqt_simulation.Hide()

		self.tab_status = wx.Panel(self, wx.ID_ANY)
		self.tab_status.Hide()
		...
		self.tab_topics = wx.Panel(self, wx.ID_ANY)
		self.tab_topics.Hide()
		...
		self.tab_states = wx.Panel(self, wx.ID_ANY)
		self.tab_states.Hide()
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_can_setup)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_tfserver_setup)
	...
	def __do_layout(self):
		...
		sizer_46.Add(self.button_can_setup, 0, wx.ALL, 4)
		sizer_46.Add(self.button_tfserver_setup, 0, wx.ALL, 4)
		...
		self.tab_setup.SetMinSize((600, 320))
		...
		self.tab_map.SetMinSize((600, 450))
		...
		self.tab_sensing.SetMinSize((600,1600))
		...
		self.tab_computing.SetMinSize((600, 1600))
		...
		self.tab_simulation.SetMinSize((600, 300))
		...
		self.sizer_1.Add(self.bitmap_logo, 0,wx.ALIGN_CENTER, 0)
		self.sizer_100 = wx.BoxSizer(wx.VERTICAL)
		self.sizer_100.Add(self.tab_setup, 0, 0, 0)
		self.sizer_100.Add(self.tab_map, 0, 0, 0)
		self.sizer_100.Add(self.tab_simulation, 0, 0, 0)
		self.sizer_1.Add(self.sizer_100, 0, 0, 0)
		self.sizer_1.Add(self.tab_sensing, 0, 0, 0)
		self.sizer_1.Add(self.tab_computing, 0, wx.ALL, 0)



		self.SetSizer(self.sizer_1)
		self.Layout()
		self.SetSize((2306, 1656))

		self.tree_ctrl_sense.SetForegroundColour(button_Foreground)
		self.tree_ctrl_sense.SetBackgroundColour(small_collour)
		self.tree_ctrl_0.SetForegroundColour(button_Foreground)
		self.tree_ctrl_0.SetBackgroundColour(small_collour)
		self.tree_ctrl_1.SetForegroundColour(button_Foreground)
		self.tree_ctrl_1.SetBackgroundColour(small_collour)
		# end wxGlade
	...
	def __set_colour(self):
		...
		# sq
		self.button_map_qs.SetForegroundColour(button_Foreground)
		self.button_map_qs.SetBackgroundColour(button_Background)
		self.button_sensing_qs.SetForegroundColour(button_Foreground)
		self.button_sensing_qs.SetBackgroundColour(button_Background)
		self.button_localization_qs.SetForegroundColour(button_Foreground)
		self.button_localization_qs.SetBackgroundColour(button_Background)
		self.button_detection_qs.SetForegroundColour(button_Foreground)
		self.button_detection_qs.SetBackgroundColour(button_Background)
		self.button_mission_planning_qs.SetForegroundColour(button_Foreground)
		self.button_mission_planning_qs.SetBackgroundColour(button_Background)
		self.button_motion_planning_qs.SetForegroundColour(button_Foreground)
		self.button_motion_planning_qs.SetBackgroundColour(button_Background)
		self.button_android_tablet_qs.SetForegroundColour(button_Foreground)
		self.button_android_tablet_qs.SetBackgroundColour(button_Background)
		self.button_oculus_rift_qs.SetForegroundColour(button_Foreground)
		self.button_oculus_rift_qs.SetBackgroundColour(button_Background)
		self.button_vehicle_gateway_qs.SetForegroundColour(button_Foreground)
		self.button_vehicle_gateway_qs.SetBackgroundColour(button_Background)
		self.button_remote_control_qs.SetForegroundColour(button_Foreground)
		self.button_remote_control_qs.SetBackgroundColour(button_Background)
		self.button_cloud_data_qs.SetForegroundColour(button_Foreground)
		self.button_cloud_data_qs.SetBackgroundColour(button_Background)
		self.button_auto_pilot_qs.SetForegroundColour(button_Foreground)
		self.button_auto_pilot_qs.SetBackgroundColour(button_Background)
		# setup
		self.button_setup_tf.SetForegroundColour(button_Foreground)
		self.button_setup_tf.SetBackgroundColour(button_Background)
		self.button_vehicle_model.SetForegroundColour(button_Foreground)
		self.button_vehicle_model.SetBackgroundColour(button_Background)
		self.button_vehicle_info.SetForegroundColour(button_Foreground)
		self.button_vehicle_info.SetBackgroundColour(button_Background)
		self.button_rosbag_setup.SetForegroundColour(button_Foreground)
		self.button_rosbag_setup.SetBackgroundColour(button_Background)
		self.button_rviz_setup.SetForegroundColour(button_Foreground)
		self.button_rviz_setup.SetBackgroundColour(button_Background)
		self.button_rqt_setup.SetForegroundColour(button_Foreground)
		self.button_rqt_setup.SetBackgroundColour(button_Background)
		# map
		self.button_point_cloud.SetForegroundColour(button_Foreground)
		self.button_point_cloud.SetBackgroundColour(button_Background)
		self.button_area_lists.SetForegroundColour(button_Foreground)
		self.button_area_lists.SetBackgroundColour(button_Background)
		self.button_vector_map.SetForegroundColour(button_Foreground)
		self.button_vector_map.SetBackgroundColour(button_Background)
		self.panel_vector_map.SetForegroundColour(button_Foreground)
		self.panel_vector_map.SetBackgroundColour(button_Background)
		self.button_tf.SetForegroundColour(button_Foreground)
		self.button_tf.SetBackgroundColour(button_Background)
		self.button_pcd_filter.SetForegroundColour(button_Foreground)
		self.button_pcd_filter.SetBackgroundColour(button_Background)
		self.button_pcd_binarizer.SetForegroundColour(button_Foreground)
		self.button_pcd_binarizer.SetBackgroundColour(button_Background)
		self.button_rosbag_map.SetForegroundColour(button_Foreground)
		self.button_rosbag_map.SetBackgroundColour(button_Background)
		self.button_rviz_map.SetForegroundColour(button_Foreground)
		self.button_rviz_map.SetBackgroundColour(button_Background)
		self.button_rqt_map.SetForegroundColour(button_Foreground)
		self.button_rqt_map.SetBackgroundColour(button_Background)
		self.choice_scene_num.SetForegroundColour(button_Foreground)
		self.choice_scene_num.SetBackgroundColour(button_Background)

		# sensing
		self.button_calibration_toolkit.SetForegroundColour(button_Foreground)
		self.button_calibration_toolkit.SetBackgroundColour(button_Background)
		self.button_calibration_publisher.SetForegroundColour(button_Foreground)
		self.button_calibration_publisher.SetBackgroundColour(button_Background)
		self.button_points_image.SetForegroundColour(button_Foreground)
		self.button_points_image.SetBackgroundColour(button_Background)
		self.button_virtual_scan_image.SetForegroundColour(button_Foreground)
		self.button_virtual_scan_image.SetBackgroundColour(button_Background)
		self.button_scan_image.SetForegroundColour(button_Foreground)
		self.button_scan_image.SetBackgroundColour(button_Background)
		self.button_rosbag_sensing.SetForegroundColour(button_Foreground)
		self.button_rosbag_sensing.SetBackgroundColour(button_Background)
		self.button_rviz_sensing.SetForegroundColour(button_Foreground)
		self.button_rviz_sensing.SetBackgroundColour(button_Background)
		self.button_rqt_sensing.SetForegroundColour(button_Foreground)
		self.button_rqt_sensing.SetBackgroundColour(button_Background)

		# computting
		self.button_synchronization.SetForegroundColour(button_Foreground)
		self.button_synchronization.SetBackgroundColour(button_Background)
		self.button_rosbag_computing.SetForegroundColour(button_Foreground)
		self.button_rosbag_computing.SetBackgroundColour(button_Background)
		self.button_rviz_computing.SetForegroundColour(button_Foreground)
		self.button_rviz_computing.SetBackgroundColour(button_Background)
		self.button_rqt_computing.SetForegroundColour(button_Foreground)
		self.button_rqt_computing.SetBackgroundColour(button_Background)
		# interface
		self.button_android_tablet_interface.SetForegroundColour(button_Foreground)
		self.button_android_tablet_interface.SetBackgroundColour(button_Background)
		self.button_oculus_rift_interface.SetForegroundColour(button_Foreground)
		self.button_oculus_rift_interface.SetBackgroundColour(button_Background)
		self.button_vehicle_gateway_interface.SetForegroundColour(button_Foreground)
		self.button_vehicle_gateway_interface.SetBackgroundColour(button_Background)
		self.button_remote_control_interface.SetForegroundColour(button_Foreground)
		self.button_remote_control_interface.SetBackgroundColour(button_Background)
		self.button_auto_pilot_interface.SetForegroundColour(button_Foreground)
		self.button_auto_pilot_interface.SetBackgroundColour(button_Background)
		self.button_statchk_lamp_l.SetForegroundColour(button_Foreground)
		self.button_statchk_lamp_l.SetBackgroundColour(button_Background)
		self.button_statchk_lamp_r.SetForegroundColour(button_Foreground)
		self.button_statchk_lamp_r.SetBackgroundColour(button_Background)
		self.button_statchk_d.SetForegroundColour(button_Foreground)
		self.button_statchk_d.SetBackgroundColour(button_Background)
		self.button_statchk_r.SetForegroundColour(button_Foreground)
		self.button_statchk_r.SetBackgroundColour(button_Background)
		self.button_statchk_b.SetForegroundColour(button_Foreground)
		self.button_statchk_b.SetBackgroundColour(button_Background)
		self.button_statchk_n.SetForegroundColour(button_Foreground)
		self.button_statchk_n.SetBackgroundColour(button_Background)
		self.button_statchk_p.SetForegroundColour(button_Foreground)
		self.button_statchk_p.SetBackgroundColour(button_Background)
		self.button_rosbag_interface.SetForegroundColour(button_Foreground)
		self.button_rosbag_interface.SetBackgroundColour(button_Background)
		self.button_rviz_interface.SetForegroundColour(button_Foreground)
		self.button_rviz_interface.SetBackgroundColour(button_Background)
		self.button_rqt_interface.SetForegroundColour(button_Foreground)
		self.button_rqt_interface.SetBackgroundColour(button_Background)

		# database
		self.button_query.SetForegroundColour(button_Foreground)
		self.button_query.SetBackgroundColour(button_Background)
		self.button_rosbag_database.SetForegroundColour(button_Foreground)
		self.button_rosbag_database.SetBackgroundColour(button_Background)
		self.button_rviz_database.SetForegroundColour(button_Foreground)
		self.button_rviz_database.SetBackgroundColour(button_Background)
		self.button_rqt_database.SetForegroundColour(button_Foreground)
		self.button_rqt_database.SetBackgroundColour(button_Background)

		# simulation
		self.button_play_rosbag_play.SetForegroundColour(button_Foreground)
		self.button_play_rosbag_play.SetBackgroundColour(button_Background)
		self.button_stop_rosbag_play.SetForegroundColour(button_Foreground)
		self.button_stop_rosbag_play.SetBackgroundColour(button_Background)
		self.label_rosbag_play_bar.SetForegroundColour(button_Foreground)
		self.label_rosbag_play_bar.SetBackgroundColour(button_Background)
		self.label_rosbag_play_pos.SetForegroundColour(button_Foreground)
		self.label_rosbag_play_pos.SetBackgroundColour(button_Background)
		self.label_rosbag_info.SetForegroundColour(button_Foreground)
		self.label_rosbag_info.SetBackgroundColour(button_Background)
		self.button_gazebo.SetForegroundColour(button_Foreground)
		self.button_gazebo.SetBackgroundColour(button_Background)
		self.button_rosbag_simulation.SetForegroundColour(button_Foreground)
		self.button_rosbag_simulation.SetBackgroundColour(button_Background)
		self.button_rviz_simulation.SetForegroundColour(button_Foreground)
		self.button_rviz_simulation.SetBackgroundColour(button_Background)
		self.button_rqt_simulation.SetForegroundColour(button_Foreground)
		self.button_rqt_simulation.SetBackgroundColour(button_Background)

		# status
		self.button_system_monitor.SetForegroundColour(button_Foreground)
		self.button_system_monitor.SetBackgroundColour(button_Background)
		self.button_ftrace.SetForegroundColour(button_Foreground)
		self.button_ftrace.SetBackgroundColour(button_Background)
		self.button_rosbag_status.SetForegroundColour(button_Foreground)
		self.button_rosbag_status.SetBackgroundColour(button_Background)
		self.button_rviz_status.SetForegroundColour(button_Foreground)
		self.button_rviz_status.SetBackgroundColour(button_Background)
		self.button_rqt_status.SetForegroundColour(button_Foreground)
		self.button_rqt_status.SetBackgroundColour(button_Background)

		# topics
		self.button_refresh_topics.SetForegroundColour(button_Foreground)
		self.button_refresh_topics.SetBackgroundColour(button_Background)
		self.button_rosbag_topics.SetForegroundColour(button_Foreground)
		self.button_rosbag_topics.SetBackgroundColour(button_Background)
		self.button_rviz_topics.SetForegroundColour(button_Foreground)
		self.button_rviz_topics.SetBackgroundColour(button_Background)
		self.button_rqt_topics.SetForegroundColour(button_Foreground)
		self.button_rqt_topics.SetBackgroundColour(button_Background)

		# states
		self.button_mainstate_0.SetForegroundColour(button_Foreground)
		self.button_mainstate_0.SetBackgroundColour(button_Background)
		self.button_mainstate_1.SetForegroundColour(button_Foreground)
		self.button_mainstate_1.SetBackgroundColour(button_Background)
		self.button_mainstate_2.SetForegroundColour(button_Foreground)
		self.button_mainstate_2.SetBackgroundColour(button_Background)
		self.button_mainstate_3.SetForegroundColour(button_Foreground)
		self.button_mainstate_3.SetBackgroundColour(button_Background)
		self.button_mainstate_4.SetForegroundColour(button_Foreground)
		self.button_mainstate_4.SetBackgroundColour(button_Background)
		self.button_mainstate_5.SetForegroundColour(button_Foreground)
		self.button_mainstate_5.SetBackgroundColour(button_Background)
		self.button_substate_acc_0.SetForegroundColour(button_Foreground)
		self.button_substate_acc_0.SetBackgroundColour(button_Background)
		self.button_substate_acc_3.SetForegroundColour(button_Foreground)
		self.button_substate_acc_3.SetBackgroundColour(button_Background)
		self.button_substate_acc_1.SetForegroundColour(button_Foreground)
		self.button_substate_acc_1.SetBackgroundColour(button_Background)
		self.button_substate_acc_4.SetForegroundColour(button_Foreground)
		self.button_substate_acc_4.SetBackgroundColour(button_Background)
		self.button_substate_acc_2.SetForegroundColour(button_Foreground)
		self.button_substate_acc_2.SetBackgroundColour(button_Background)
		self.button_substate_acc_5.SetForegroundColour(button_Foreground)
		self.button_substate_acc_5.SetBackgroundColour(button_Background)
		self.button_substate_str_straight.SetForegroundColour(button_Foreground)
		self.button_substate_str_straight.SetBackgroundColour(button_Background)
		self.button_substate_str_left.SetForegroundColour(button_Foreground)
		self.button_substate_str_left.SetBackgroundColour(button_Background)
		self.button_substate_str_right.SetForegroundColour(button_Foreground)
		self.button_substate_str_right.SetBackgroundColour(button_Background)
		self.button_substate_behavior_lanechange_left_copy.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_lanechange_left_copy.SetBackgroundColour(button_Background)
		self.button_substate_behavior_lanechange_right.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_lanechange_right.SetBackgroundColour(button_Background)
		self.button_substate_behavior_obstacle_avoid.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_obstacle_avoid.SetBackgroundColour(button_Background)
		self.button_substate_behavior_clear.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_clear.SetBackgroundColour(button_Background)
		self.button_substate_behavior_null_0.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_null_0.SetBackgroundColour(button_Background)
		self.button_substate_behavior_null_1.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_null_1.SetBackgroundColour(button_Background)
		self.button_substate_behavior_null_2.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_null_2.SetBackgroundColour(button_Background)
		self.button_substate_behavior_null_3.SetForegroundColour(button_Foreground)
		self.button_substate_behavior_null_3.SetBackgroundColour(button_Background)
		self.button_rosbag_states.SetForegroundColour(button_Foreground)
		self.button_rosbag_states.SetBackgroundColour(button_Background)
		self.button_rviz_states.SetForegroundColour(button_Foreground)
		self.button_rviz_states.SetBackgroundColour(button_Background)
		self.button_rqt_states.SetForegroundColour(button_Foreground)
		self.button_rqt_states.SetBackgroundColour(button_Background)

		# tab
		self.tab_qs.SetBackgroundColour(small_collour)
		self.tab_setup.SetBackgroundColour(small_collour)
		self.tab_map.SetBackgroundColour(small_collour)
		self.tab_sensing.SetBackgroundColour(small_collour)
		self.tab_computing.SetBackgroundColour(small_collour)
		self.tab_interface.SetBackgroundColour(small_collour)
		self.tab_database.SetBackgroundColour(small_collour)
		self.tab_simulation.SetBackgroundColour(small_collour)
		self.tab_status.SetBackgroundColour(small_collour)
		self.tab_topics.SetBackgroundColour(small_collour)
		self.tab_states.SetBackgroundColour(small_collour)

		# panel
		self.panel_pcd_binarizer.SetForegroundColour(button_Foreground)
		self.panel_pcd_binarizer.SetBackgroundColour(small_collour)
		self.panel_sensing.SetForegroundColour(button_Foreground)
		self.panel_sensing.SetBackgroundColour(small_collour)
		self.panel_rosbag_play.SetForegroundColour(button_Foreground)
		self.panel_rosbag_play.SetBackgroundColour(small_collour)

		# ScrolledWindow
		self.panel_5.SetForegroundColour(button_Foreground)
		self.panel_5.SetBackgroundColour(small_collour)
		self.panel_3.SetForegroundColour(button_Foreground)
		self.panel_3.SetBackgroundColour(small_collour)
		self.panel_4.SetForegroundColour(button_Foreground)
		self.panel_4.SetBackgroundColour(small_collour)
		self.panel_topics_list.SetForegroundColour(button_Foreground)
		self.panel_topics_list.SetBackgroundColour(small_collour)
		self.panel_topics_info.SetForegroundColour(button_Foreground)
		self.panel_topics_info.SetBackgroundColour(small_collour)
